...
const SignUpAdmin = () => {
    ...
    .post(
    `${process.env.REACT_APP_BACKEND_URL_ADRESS}/api/admins/signup`,
    JSON.stringify({cafeName:formData.cafeName, contactNumber: formData.contactNumber, password: formData.password }),
    {
        headers: {
        ...
        <div className='signup'>
            <div className="signup-container">
                ...
                <div className="signup-field">
                    <div className="input"><img src={User_Icon} alt="" /> <input type="text" placeholder='Cafe Name' name="cafeName" className='name-input' value={formData.cafeName} onChange={changeHandler}/></div>
                ...
                <p className='signup-login'>
                    ...
                    <Link to="/adminlogin"><span>Login</span></Link>
                </p>
            </div>
